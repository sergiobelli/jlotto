...
import net.sb.jlotto.cli.helpers.LottoHelper;
...
public class JLottoView extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            ...
            aboutBox = new JLottoAboutBox(mainFrame);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(net.sb.jlotto.cli.JLottoApp.class).getContext().getResourceMap(JLottoView.class);
        txtInserimento.setText(resourceMap.getString("txtInserimento.text")); // NOI18N
        txtInserimento.setName("txtInserimento"); // NOI18N
        txtInserimento.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtInserimentoKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtInserimentoKeyTyped(evt);
            }
        });
        ...
        txtRisultato.setText(resourceMap.getString("txtRisultato.text")); // NOI18N
        txtRisultato.setName("txtRisultato"); // NOI18N

        jLabel2.setText(resourceMap.getString("jLabel2.text")); // NOI18N
        jLabel2.setMaximumSize(new java.awt.Dimension(40, 17));
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtRisultato, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(net.sb.jlotto.cli.JLottoApp.class).getContext().getActionMap(JLottoView.class, this);
    ...
    private void txtInserimentoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtInserimentoKeyTyped
